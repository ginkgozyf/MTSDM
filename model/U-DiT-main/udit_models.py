...
import sys
sys.path.append('/root/myWorkPlace/MTSDM/MTSDM')
...
class OverlapPatchEmbed(nn.Module):
    def __init__(self, in_c=14, embed_dim=48, bias=False):
...
if __name__=="__main__":
    ...
    model = U_DiT_S()
    # model.load_state_dict(torch.load('/root/myWorkPlace/MTSDM/MTSDM/results/004-U-DiT-S/checkpoints/best_loss_checkpoint.pt')["model"])
    model.cuda()
    model.eval()
    x = torch.randn(1, 1, 14, 48)
    ...
    inputs = torch.rand(1, 14, 32, 32).cuda()
