import sys
import os
os.chdir("/root/myWorkPlace/MTSDM/MTSDM/model/source-Diff-MTS")
import numpy as np
import pandas as pd
...
if __name__ == "__main__":
    ...
    print(f"train_feature_slice.shape: {train_feature_slice.shape}")
    print(f"train_label_slice.shape: {train_label_slice.shape}")
